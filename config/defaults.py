...
# Quantization-aware training for CLIP-ReID.
_C.MODEL.QAT = CN()
_C.MODEL.QAT.ENABLED = False
# Kept for old experiment YAMLs.  New selective flags below take precedence.
_C.MODEL.QAT.QUANTIZE_ATTENTION_INTERNALS = False
_C.MODEL.QAT.VISUAL_ONLY = True
_C.MODEL.QAT.QUANTIZE_TEXT_ENCODER = False
_C.MODEL.QAT.QUANTIZE_PATCH_EMBED = False
_C.MODEL.QAT.QUANTIZE_MLP = True
_C.MODEL.QAT.QUANTIZE_QKV_PROJ = True
_C.MODEL.QAT.QUANTIZE_ATTN_OUT_PROJ = True
_C.MODEL.QAT.QUANTIZE_QK_MATMUL = False
_C.MODEL.QAT.QUANTIZE_ATTN_PROB = False
_C.MODEL.QAT.QUANTIZE_AV_MATMUL = False
_C.MODEL.QAT.EXCLUDE_FIRST_N_BLOCKS = 0
_C.MODEL.QAT.EXCLUDE_LAST_N_BLOCKS = 2
_C.MODEL.QAT.FP32_MODULE_PATTERNS = ()
_C.MODEL.QAT.SENSITIVITY_JSON = ""
_C.MODEL.QAT.MAX_MAP_DROP_PER_MODULE = 0.005
_C.MODEL.QAT.WEIGHT_BITS = 8
_C.MODEL.QAT.ACTIVATION_BITS = 8
_C.MODEL.QAT.ACTIVATION_OBSERVER = "moving_average"
_C.MODEL.QAT.ACTIVATION_PERCENTILE = 99.99
_C.MODEL.QAT.CALIBRATION_BATCHES = 50
_C.MODEL.QAT.DISABLE_OBSERVER_EPOCH = 2
_C.MODEL.QAT.SMOOTHING = CN()
_C.MODEL.QAT.SMOOTHING.ENABLED = True
_C.MODEL.QAT.SMOOTHING.ALPHA = 0.5
_C.MODEL.QAT.SMOOTHING.AUTO_SEARCH = False
_C.MODEL.QAT.DISTILLATION = CN()
_C.MODEL.QAT.DISTILLATION.ENABLED = True
_C.MODEL.QAT.DISTILLATION.FEATURE_WEIGHT = 1.0
_C.MODEL.QAT.DISTILLATION.RELATION_WEIGHT = 5.0
_C.MODEL.QAT.DISTILLATION.DISTANCE_WEIGHT = 0.0
_C.MODEL.QAT.DISTILLATION.USE_PRE_BN_FEATURE = True
